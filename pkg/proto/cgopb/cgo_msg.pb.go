...
type LoadIndexInfo struct {
	...
	CurrentScalarIndexVersion int32                 `protobuf:"varint,18,opt,name=current_scalar_index_version,json=currentScalarIndexVersion,proto3" json:"current_scalar_index_version,omitempty"` // scalar index storage format version
}
