...
type LoadTextIndexInfo struct {
	...
	CurrentScalarIndexVersion int32                 `protobuf:"varint,11,opt,name=current_scalar_index_version,json=currentScalarIndexVersion,proto3" json:"current_scalar_index_version,omitempty"` // format version for unified index
}
