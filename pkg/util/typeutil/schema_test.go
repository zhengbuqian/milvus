				...
				Vectors: &schemapb.VectorField{
					...
					Data: &schemapb.VectorField_SparseFloatVector{
						SparseFloatVector: &schemapb.SparseFloatArray{
							Dim:      dim,
							Contents: []*schemapb.SparseFloatRow{fieldValue.(*schemapb.SparseFloatRow)},
						},
					},
				},
			},
...
func TestDeleteFieldData(t *testing.T) {
	...
	tmpSparseFloatVector.Contents = []*schemapb.SparseFloatRow{SparseFloatVector.Contents[0]}
	...
	tmpSparseFloatVector = proto.Clone(SparseFloatVector).(*schemapb.SparseFloatArray)
	tmpSparseFloatVector.Contents = []*schemapb.SparseFloatRow{SparseFloatVector.Contents[1]}
...
func TestMergeFieldData(t *testing.T) {
	sparseFloatRows := []*schemapb.SparseFloatRow{
		// 3 rows for dst
		{
			Indices: &schemapb.IntArray{Data: []int32{30, 41, 52}},
			Values:  &schemapb.FloatArray{Data: []float32{1.1, 1.2, 1.3}},
		...
		{
			Indices: &schemapb.IntArray{Data: []int32{300, 410, 520}},
			Values:  &schemapb.FloatArray{Data: []float32{1.1, 1.2, 1.3}},
		},
		// 3 rows for src
		{
			Indices: &schemapb.IntArray{Data: []int32{600, 800, 2300}},
			Values:  &schemapb.FloatArray{Data: []float32{2.1, 2.2, 2.3}},
		},
		{
			Indices: &schemapb.IntArray{Data: []int32{90, 141, 352}},
			Values:  &schemapb.FloatArray{Data: []float32{1.1, 1.2, 1.3}},
		},
		{
			Indices: &schemapb.IntArray{Data: []int32{160, 280, 340}},
			Values:  &schemapb.FloatArray{Data: []float32{2.1, 2.2, 2.3}},
		},
	}
...
func TestValidateSparseFloatRows(t *testing.T) {
	t.Run("valid rows", func(t *testing.T) {
		rows := []*schemapb.SparseFloatRow{
			{
				Indices: &schemapb.IntArray{Data: []int32{1, 3, 5}},
				Values:  &schemapb.FloatArray{Data: []float32{1.0, 2.0, 3.0}},
			},
			{
				Indices: &schemapb.IntArray{Data: []int32{2, 4, 6}},
				Values:  &schemapb.FloatArray{Data: []float32{4.0, 5.0, 6.0}},
			},
			{
				Indices: &schemapb.IntArray{Data: []int32{0, 7, 8}},
				Values:  &schemapb.FloatArray{Data: []float32{7.0, 8.0, 9.0}},
			},
		}
	...
	t.Run("nil indices", func(t *testing.T) {
		rows := []*schemapb.SparseFloatRow{
			{
				Indices: nil,
				Values:  &schemapb.FloatArray{Data: []float32{1.0, 2.0, 3.0}},
	...
	t.Run("mismatched lengths", func(t *testing.T) {
		rows := []*schemapb.SparseFloatRow{
			{
				Indices: &schemapb.IntArray{Data: []int32{0, 1}},
				Values:  &schemapb.FloatArray{Data: []float32{1.0, 2.0, 3.0}},
			},
		}
		err := ValidateSparseFloatRows(rows...)
	...
	t.Run("negative index", func(t *testing.T) {
		rows := []*schemapb.SparseFloatRow{
			{
				Indices: &schemapb.IntArray{Data: []int32{-1, 0, 1}},
				Values:  &schemapb.FloatArray{Data: []float32{1.0, 2.0, 3.0}},
			},
		}
		err := ValidateSparseFloatRows(rows...)
	...
	t.Run("empty indices or values is acceptable", func(t *testing.T) {
		rows := []*schemapb.SparseFloatRow{
			{
				Indices: &schemapb.IntArray{Data: []int32{}},
				Values:  &schemapb.FloatArray{Data: []float32{}},
			},
		}
		err := ValidateSparseFloatRows(rows...)
		assert.NoError(t, err)
	...
	t.Run("multiple rows with nil", func(t *testing.T) {
		rows := []*schemapb.SparseFloatRow{
			{
				Indices: &schemapb.IntArray{Data: []int32{0, 1, 2}},
				Values:  &schemapb.FloatArray{Data: []float32{1.0, 2.0, 3.0}},
