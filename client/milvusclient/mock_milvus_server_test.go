...
// ReplaceIndex provides a mock function with given fields: _a0, _a1
func (_m *MilvusServiceServer) ReplaceIndex(_a0 context.Context, _a1 *milvuspb.ReplaceIndexRequest) (*commonpb.Status, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r0 *commonpb.Status
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *milvuspb.ReplaceIndexRequest) (*commonpb.Status, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *milvuspb.ReplaceIndexRequest) *commonpb.Status); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*commonpb.Status)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *milvuspb.ReplaceIndexRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// MilvusServiceServer_ReplaceIndex_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReplaceIndex'
type MilvusServiceServer_ReplaceIndex_Call struct {
	*mock.Call
}

// ReplaceIndex is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 *milvuspb.ReplaceIndexRequest
func (_e *MilvusServiceServer_Expecter) ReplaceIndex(_a0 interface{}, _a1 interface{}) *MilvusServiceServer_ReplaceIndex_Call {
	return &MilvusServiceServer_ReplaceIndex_Call{Call: _e.mock.On("ReplaceIndex", _a0, _a1)}
}

func (_c *MilvusServiceServer_ReplaceIndex_Call) Run(run func(_a0 context.Context, _a1 *milvuspb.ReplaceIndexRequest)) *MilvusServiceServer_ReplaceIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*milvuspb.ReplaceIndexRequest))
	})
	return _c
}

func (_c *MilvusServiceServer_ReplaceIndex_Call) Return(_a0 *commonpb.Status, _a1 error) *MilvusServiceServer_ReplaceIndex_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MilvusServiceServer_ReplaceIndex_Call) RunAndReturn(run func(context.Context, *milvuspb.ReplaceIndexRequest) (*commonpb.Status, error)) *MilvusServiceServer_ReplaceIndex_Call {
	_c.Call.Return(run)
	return _c
}
