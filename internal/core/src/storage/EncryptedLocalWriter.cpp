...
EncryptedLocalWriter::EncryptedLocalWriter(
...
void
EncryptedLocalWriter::WriteEntry(const std::string& name,
                                 const void* data,
                                 size_t size) {
...
void
EncryptedLocalWriter::WriteEntry(const std::string& name, int fd, size_t size) {
    AssertInfo(!finished_, "Cannot write after Finish() has been called");
    CheckDuplicateName(name);
...
void
EncryptedLocalWriter::EncryptAndWriteSlices(const std::string& name,
...
void
EncryptedLocalWriter::UploadLocalFile() {
