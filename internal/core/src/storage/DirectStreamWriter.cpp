...
DirectStreamWriter::DirectStreamWriter(
...
void
DirectStreamWriter::WriteEntry(const std::string& name,
                               const void* data,
                               size_t size) {
...
void
DirectStreamWriter::WriteEntry(const std::string& name, int fd, size_t size) {
    AssertInfo(!finished_, "Cannot write after Finish() has been called");
    CheckDuplicateName(name);
