...
// after W1 "Builder + `Artifact::Serialize` + a storage sink; the Creator
...
//        no Builder in scope.
//
// NOTE the class name is now inaccurate: the Builder face is shared by both
// families (§11.3, "Builder: one face, differences absorbed by
