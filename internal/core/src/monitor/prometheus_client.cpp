...
DEFINE_PROMETHEUS_HISTOGRAM_WITH_BUCKETS(
    internal_cache_load_latency_memory,
    internal_cache_load_latency,
    cacheMemoryLabel,
    secondsBuckets);
DEFINE_PROMETHEUS_HISTOGRAM_WITH_BUCKETS(
    internal_cache_load_latency_disk,
    internal_cache_load_latency,
    cacheDiskLabel,
    secondsBuckets);
DEFINE_PROMETHEUS_HISTOGRAM_WITH_BUCKETS(
...
std::map<std::string, std::string> cacheHitMemoryLabels = {{"result", "hit"}, {"location", "memory"}};
std::map<std::string, std::string> cacheHitDiskLabels = {{"result", "hit"}, {"location", "disk"}};
std::map<std::string, std::string> cacheHitMixedLabels = {{"result", "hit"}, {"location", "mixed"}};
std::map<std::string, std::string> cacheMissMemoryLabels = {{"result", "miss"}, {"location", "memory"}};
std::map<std::string, std::string> cacheMissDiskLabels = {{"result", "miss"}, {"location", "disk"}};
std::map<std::string, std::string> cacheMissMixedLabels = {{"result", "miss"}, {"location", "mixed"}};
...
std::map<std::string, std::string> cacheLoadSuccessMemoryLabels = {{"status", "success"}, {"location", "memory"}};
std::map<std::string, std::string> cacheLoadSuccessDiskLabels = {{"status", "success"}, {"location", "disk"}};
std::map<std::string, std::string> cacheLoadSuccessMixedLabels = {{"status", "success"}, {"location", "mixed"}};
std::map<std::string, std::string> cacheLoadFailMemoryLabels = {{"status", "fail"}, {"location", "memory"}};
std::map<std::string, std::string> cacheLoadFailDiskLabels = {{"status", "fail"}, {"location", "disk"}};
std::map<std::string, std::string> cacheLoadFailMixedLabels = {{"status", "fail"}, {"location", "mixed"}};
