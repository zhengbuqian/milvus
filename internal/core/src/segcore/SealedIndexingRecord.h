...
// `shared_ptr<CacheSlot<IndexBase>>` (index/Index.h:167), and refactor phase 1
// retires `IndexBase` — `index::IndexReaderBase` takes over the type-erased
// handle role, so the entry becomes `CacheSlot<index::IndexReaderBase>` plus a
