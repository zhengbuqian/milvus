...
SegmentInternalInterface::FillPrimaryKeys(const query::Plan* plan,
    ...
    results.search_storage_cost_.scanned_remote_bytes += op_ctx.storage_usage.scanned_cold_bytes.load();
    results.search_storage_cost_.scanned_total_bytes += op_ctx.storage_usage.scanned_total_bytes.load();
}
...
SegmentInternalInterface::Retrieve(tracer::TraceContext* trace_ctx,
    ...
    results->set_scanned_remote_bytes(retrieve_results.retrieve_storage_cost_.scanned_remote_bytes);
    results->set_scanned_total_bytes(retrieve_results.retrieve_storage_cost_.scanned_total_bytes);
...
SegmentInternalInterface::FillTargetEntry(
    ...
    results->set_scanned_remote_bytes(
        results->scanned_remote_bytes() + op_ctx.storage_usage.scanned_cold_bytes.load());
    results->set_scanned_total_bytes(
        results->scanned_total_bytes() + op_ctx.storage_usage.scanned_total_bytes.load());
}
