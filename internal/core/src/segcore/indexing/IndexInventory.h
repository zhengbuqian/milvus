...
// borrowing any query mixin from its IndexReaderBase.
//
...
class IndexInventory {
 public:
    ...
    struct Entry {
        ...
        // owns its IndexReaderBase; query consumers only borrow it through pins.
        RootSlot slot;
    };
    ...
    // Metadata-only capability lookup; must not pin payloads.
...
//   - Readers report owned resources through IndexReaderBase; translators
