...
flowchart TB
    ...
    subgraph segment["Sealed Segment"]
        ...
        slot["CacheSlot&lt;IndexReaderBase&gt;<br/>cold / warming / loaded"]
    ...
    subgraph artifact["Artifact source 与 reader cell"]
        ...
        reader["IndexReaderBase<br/>unique_ptr 由 cache cell 独占"]
    end
...
flowchart TB
    ...
    subgraph execute["执行与生命周期"]
        reader_view["borrowed query mixin / VectorReader<br/>消费者不拥有 reader"]
