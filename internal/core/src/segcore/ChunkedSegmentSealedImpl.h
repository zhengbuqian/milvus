...
class ChunkedSegmentSealedImpl : public SegmentSealed {
 ...
 public:
    ...
    //
    // TWO W1 NOTES (core_refactor/01-scalar-index.md):
    //
    ...
    //    THEY ARE. §5.8 "元素→行映射的归属：列的派生物，索引不持有" nails it
    //    down with three facts that all hold here: the map is PRODUCED BY
