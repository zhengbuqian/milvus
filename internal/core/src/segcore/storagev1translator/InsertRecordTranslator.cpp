...
InsertRecordTranslator::get_cells(
    ...
    AssertInfo(pk_field_id.has_value(), "primary key field not found in schema");
    ...
    if (!is_sorted_by_pk_) {
        ...
        AssertInfo(it != chunked_segment_->fields_.end(), "primary key field not found in segment");
