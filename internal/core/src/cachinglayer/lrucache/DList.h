...
class DList {
 public:
    ...
    // 2. when a cell is loaded as a bonus, we need to touch it to refresh the LRU order and update
 ...
 private:
    ...
    // Return true if we can achieve the goal and have done the eviction, false if we cannot 
    // achieve the expected_slack goal.
    ...
    // return true if ListNode is in the list, false otherwise.
    bool
