...
// split across four homes: `GrowingTextIndex` (Appender interface), the text
// `IndexBuilder` (Builder interface, both for the build service and for
// build-in-place — §7 point 3), and the text `IndexLoader` (Loader interface).
// This interface is only the read side.
