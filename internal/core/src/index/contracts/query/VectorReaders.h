...
// GrowingIndex provides common publication and GrowingIndexSnapshotPin; Appendable<Batch>
// provides the typed input interface. Both are declared in GrowingIndex.h.
