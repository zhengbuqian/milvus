...
// Type-erased ownership and metadata base for an opened index. Scalar query
// interfaces are independent pure mixins; the unified VectorReader derives
// from this base directly. Pin once, then cross-cast to the required query
// contract; queries do not need the concrete implementation type.
//
// Construction, serialization, and loading belong to ArtifactBuilder,
// Artifact, and Loader.
