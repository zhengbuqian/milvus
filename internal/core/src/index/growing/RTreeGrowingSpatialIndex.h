...
#include "index/growing/GrowingSpatialIndexFace.h"
#include "index/scalar/spatial/RTreeEngine.h"

// The growing GEOMETRY appender — TODAY'S ONLY WORKING GROWING SCALAR INDEX.
//
// See core_refactor/01-scalar-index.md §7, §7.1, §5.6, and the contract-gap note
// in GrowingSpatialIndexFace.h (this family fits none of the three appender
// classes the contract declares).
//
