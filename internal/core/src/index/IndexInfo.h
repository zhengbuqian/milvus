...
// `segcore/Utils.cpp:1484`, `segcore/storagev1translator/V1SealedIndexTranslator.cpp:119`
// — and those call sites belong to the segcore/indexbuilder half of this wave.
