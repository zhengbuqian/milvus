...
// the four-interface sense (01-scalar-index.md §3, §6.1): it is not a class,
// has no `Seal()`, produces no `storage::Artifact`, and holds no state. It is
// the SHAPE CONVERSION that sits in front of a builder's push path — the step
// that turns "row of JSON" into "value of type T at this path", after which an
