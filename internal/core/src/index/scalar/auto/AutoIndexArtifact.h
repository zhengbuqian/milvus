...
// by AUTO in the existing index_type marker.
class AutoIndexArtifact final : public storage::Artifact {
 public:
    AutoIndexArtifact(storage::ArtifactPtr inner, ScalarIndexType selector);
