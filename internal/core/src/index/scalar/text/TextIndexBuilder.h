...
//
// See 01-scalar-index.md §6.1 (the one builder face), §6.1.1 (input forms;
...
//
// The remaining half of `TextMatchIndex.cpp:36-57` — the真 growing writer with a
// 200ms commit interval and background merge (`SegmentGrowingImpl.cpp:2496`) —
// is the APPENDER face, `GrowingTextIndex` in index/contracts/GrowingIndex.h.
// It is NOT in this directory and is owned by the growing-side work.
...
// ARGUMENTS" — they never become extra methods on the builder face.
