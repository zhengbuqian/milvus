...
// CAPABILITY answers, not programming errors). Cleanest fix would be a form-typed
// builder face or a defaulted `Add`; contract owner's call. See the report.
//
