...
class TestChunkSegmentStorageV2 : public testing::TestWithParam<bool> {
 protected:
    ...
    SetUp() override {
        ...
        std::vector<std::vector<int>> column_groups = {{0, 1, 2}, {3, 4}}; // short columns and long columns
        ...
        for (int chunk_id = 0; chunk_id < chunk_num; chunk_id++, start_id += test_data_count) {
